...
class FluxParams:
    ...
    def validate(self):
        ...
        # if self.output_img_height % 32 != 0:
        #     raise ValueError(
        #         f"Output image height {self.output_img_height} must be divisible by 32."
        #     )
        # if self.output_img_width % 32 != 0:
        #     raise ValueError(
        #         f"Output image height {self.output_img_width} must be divisible by 32."
        #     )
