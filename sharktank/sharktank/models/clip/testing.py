...
from .export import (
    ...
    export_clip_text_model_iree_parameters,
...
def export_clip_toy_text_model_default_iree_test_data(output_path_prefix: str):
    ...
    input_ids_output_path = f"{output_path_prefix}_arg0_input_ids.irpa"
    expected_last_hidden_state_output_path = (
        f"{output_path_prefix}_expected_result0_last_hidden_state_"
...
def export_clip_text_model_iree_test_data(
    ...
    if input_ids_output_path is not None:
        ...
        param_builder.add_tensor("", input_ids)
        param_builder.save(input_ids_output_path)
    ...
    param_builder = ParameterArchiveBuilder()
    param_builder.add_tensor("", expected_last_hidden_state)
    param_builder.save(expected_last_hidden_state_output_path)
